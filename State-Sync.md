...
Let's set variables:
```
SNAP_RPC="https://persistenceCoreMain-rpc.ytwofund.pro:443"
...
You can also use an alternative method and use the [Snapshot](https://github.com/YTWOFUND/PersistenceCore-service/blob/main/Snapshot.md).
